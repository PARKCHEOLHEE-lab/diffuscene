...
output_dir=./cluster/balrog/jtang/rearrange_with_validation_data/$exp_name/gen_top2down_notexture_nofloor
...
# NOTE: there is no model checkpoint for diningrooms rearrangement
# ####'diningrooms'
# config="../config/rearrange/diffusion_diningrooms_instancond_lat32_v_rearrange.yaml"
# exp_name="diningrooms_rearrange"
# weight_file=$exp_dir/$exp_name/???  
# threed_future='./cluster/balrog/jtang/3d_front_processed/threed_future_model_diningroom.pkl'
# output_dir=./cluster/balrog/jtang/rearrange_with_validation_data/$exp_name/gen_top2down_notexture_nofloor
