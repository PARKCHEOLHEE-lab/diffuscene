...
echo -e "Computing FID scores with clip and without global rotation checking for bedrooms rearrangement..."
...
echo -e "Computing FID scores with clip and without global rotation checking for livingrooms rearrangement..."
python compute_fid_scores.py \
